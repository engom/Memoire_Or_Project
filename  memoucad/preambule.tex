...
\ding{43} Les m\'etaheuristiques peuvent faire usage de l'exp\'erience accumul\'ee durant la recherche de l'optimum pour mieux guider la suite du processus de 
recherche.

\ding{43}  Un des enjeux de la conception des m\'etaheuristiques est donc de faciliter le choix d'une m\'ethode et le r\'eglage des param\'etres pour
